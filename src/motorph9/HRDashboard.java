...
import javax.swing.*;
import java.awt.*;
import motorph9.Dashboard;
import motorph9.EmployeeList;
import motorph9.Employees;
import motorph9.EmployeeService;
/**
 *
...
public class HRDashboard extends Dashboard {
    ...
    public HRDashboard(User user) {
        ...
        initComponents();
        updateTimeAndDate(jLabelTime, jLabelDate);
    }

    private void showEmployeeDetails(String employeeId) {
        EmployeeList employee = employeeService.getEmployeeById(employeeId);
        if (employee != null) {
            jLabelDashname.setText(employee.getFullName());
            jLabelDashempnum.setText("Employee Number: " + employee.getEmployeeId());
            jLabelPosition.setText("Position: " + employee.getPosition());
        } else {
    ...
    private void jButtonViewAllEmployeesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonViewAllEmployeesActionPerformed
        // TODO add your handling code here:
         EmployeeList newClassInstance = new EmployeeList(this);
                 newClassInstance.setVisible(true);
