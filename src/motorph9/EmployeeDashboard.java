...
public class EmployeeDashboard extends javax.swing.JFrame { 
    ...
    public EmployeeDashboard(String firstName, String employeeId) {
    ...
    private void showEmployeeDetails(String employeeId){
        try {
            ...
            String[] userInfo = employeeService.getEmployeeDetails(employeeID);
    ...
    private void initComponents() {
        ...
        jLabelTitleProfile.setText("My Profile");
        ...
        jLabelTitleSupport.setText("Request");
    ...
    private void jButtonLeavereqActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jButtonWalletActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jButtonDashboardMousePressed(java.awt.event.MouseEvent evt) {
    }

    private void jButtonSupportActionPerformed(java.awt.event.ActionEvent evt) {
